...
//! Example docs
//! In this example, the first 8192 blocks of the Ethereum blockchain are verified
//! both internally and externally.
//! NOTICE: due to file size size of the files necessary for the examples, they
//! were stored [in another repo](https://github.com/semiotic-ai/ve-assets)
